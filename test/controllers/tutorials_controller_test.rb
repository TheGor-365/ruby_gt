...
class TutorialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutorial" do
    assert_difference("Tutorial.count") do
      post tutorials_url, params: { tutorial: { body: @tutorial.body, description: @tutorial.description, language_id: @tutorial.language_id, overview: @tutorial.overview, path: @tutorial.path, title: @tutorial.title } }
    end
  ...
  test "should update tutorial" do
    patch tutorial_url(@tutorial), params: { tutorial: { body: @tutorial.body, description: @tutorial.description, language_id: @tutorial.language_id, overview: @tutorial.overview, path: @tutorial.path, title: @tutorial.title } }
