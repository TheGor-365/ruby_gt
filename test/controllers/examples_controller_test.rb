...
class ExamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create example" do
    assert_difference("Example.count") do
      post examples_url, params: { example: { body: @example.body, description: @example.description, language_id: @example.language_id, overview: @example.overview, path: @example.path, title: @example.title } }
    end
  ...
  test "should update example" do
    patch example_url(@example), params: { example: { body: @example.body, description: @example.description, language_id: @example.language_id, overview: @example.overview, path: @example.path, title: @example.title } }
